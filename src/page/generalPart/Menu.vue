<template>
  <div style="margin-top: 20px;">
    ...
    <el-row class="containt">
        ...
        <el-form class="filterBlock" :inline="true" :gutter="20">
          <el-row class="filterContent">
            <el-form-item label="板块">
              <el-select  placeholder="请选择板块" v-model="filters.plate_id">
      ...
      <el-table :data="tableTreeDdata" stripe size="medium" style="width: 100%;" v-loading="loading" element-loading-text="拼命加载中" tooltip-effect="dark">
      ...
      <el-dialog :title="!dataForm.id ? '新增' : '修改'" width="40%" :visible.sync="dialogVisible" :close-on-click-modal="false">
        <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="submitForm()" label-width="80px" :size="size" style="text-align:left;">
          <el-form-item label="所属板块" prop="plate_id">
              <el-select  placeholder="请选择板块" v-model="dataForm.plate_id">
                <el-option v-for="plate in allPlate" :key="plate.id" :label="plate.description" :value="plate.id">
                </el-option>
              </el-select>
          </el-form-item>
