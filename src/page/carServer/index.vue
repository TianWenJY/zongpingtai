...
<template>
  <div class="indexPage">
    ...
    <div id="nav">
      <el-col :md="24">
        <el-menu default-active="/carServer" class="el-menu-vertical" background-color="#545c64" text-color="#fff" active-text-color="#ffd04b" :collapse="isCollapse" unique-opened router>
...
export default {
  ...
  data() {
    return {
      ...
      tableTreeDdata: [],
      includedComponents: "",
      editableTabsValue: "carServer_statics",
      isCollapse: false,
      bread: {
        partName: "汽车服务板块",
        fatherTag: "监控",
